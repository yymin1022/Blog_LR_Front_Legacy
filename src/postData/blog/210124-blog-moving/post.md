...
약 두달간 **React.js**를 공부하고 간단하게나마 블로그를 제작하는 프로젝트를 진행해보았습니다.

그 끝에 개인적으로는 꽤나 만족스러운 결과물을 얻을 수 있었고,

개인적으로 활용중인 **NAS**를 이용해 호스팅까지 직접 진행하는 것으로 구축을 해서

현재 이 블로그를 운영하고 있습니다.

아직 부족한점이 있긴 하나, 차차 개선하고 기능도 추가하며 개발을 해 나가는 방면으로 계획하고 있습니다! 
